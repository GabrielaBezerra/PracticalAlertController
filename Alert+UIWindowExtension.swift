//
//  Alert+UIWindowExtension.swift
//  PracticalAlertController
//
//  Created by Gabriela Bezerra on 13/04/18.
//  Copyright © 2018 Gabriela Bezerra. All rights reserved.
//
...
class Alert {
    ...
    static func showYesOrNo(title: String, msg: String, view: UIViewController? = nil, function: @escaping (()->()) = { } ) {
        if !isBeingPresented {
            ...
            let noAction  = UIAlertAction(title: "Não", style: .default) { UIAlertAction in isBeingPresented = false }
